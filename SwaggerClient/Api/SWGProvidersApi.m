...
NSString* kSWGProvidersApiErrorDomain = @"SWGProvidersApiErrorDomain";
NSInteger kSWGProvidersApiMissingParamErrorCode = 234513;
...
/// Agregar Proveedor
/// 
///  @param varNewProvider  
///
///  @returns NSString*
///
-(NSURLSessionTask*) providersAddProviderWithVarNewProvider: (SWGNewProvider*) varNewProvider
    completionHandler: (void (^)(NSString* output, NSError* error)) handler {
    // verify the required parameter 'varNewProvider' is set
    if (varNewProvider == nil) {
        NSParameterAssert(varNewProvider);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"varNewProvider"] };
            NSError* error = [NSError errorWithDomain:kSWGProvidersApiErrorDomain code:kSWGProvidersApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/Providers"];
...
-(NSURLSessionTask*) providersDeleteByIDWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/Providers/{id}"];
...
///
///  @returns SWGProviderListItemPage*
///
-(NSURLSessionTask*) providersGetProvidersWithFilter: (NSString*) filter
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGProviderListItemPage*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGProviderListItemPage*)data, error);
                                }
                            }];
}
