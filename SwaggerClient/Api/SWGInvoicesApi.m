...
-(NSURLSessionTask*) invoicesAddInvoiceWithVarNewInvoice: (SWGNewInvoice*) varNewInvoice
    ...
    // verify the required parameter 'varNewInvoice' is set
    if (varNewInvoice == nil) {
        NSParameterAssert(varNewInvoice);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"varNewInvoice"] };
...
-(NSURLSessionTask*) invoicesAddPaymentWithVarNewPayment: (SWGNewPayment*) varNewPayment
    ...
    // verify the required parameter 'varNewPayment' is set
    if (varNewPayment == nil) {
        NSParameterAssert(varNewPayment);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"varNewPayment"] };
            NSError* error = [NSError errorWithDomain:kSWGInvoicesApiErrorDomain code:kSWGInvoicesApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/Invoices/Payment"];
...
-(NSURLSessionTask*) invoicesGetPDFWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/Invoices/{id}/pdf"];
...
-(NSURLSessionTask*) invoicesGetXMLWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/Invoices/{id}/xml"];
