...
-(NSURLSessionTask*) productsAddProductWithVarNewProduct: (SWGNewProduct*) varNewProduct
    ...
    // verify the required parameter 'varNewProduct' is set
    if (varNewProduct == nil) {
        NSParameterAssert(varNewProduct);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"varNewProduct"] };
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/Products"];
...
-(NSURLSessionTask*) productsDeleteByIDWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/Products/{id}"];
...
-(NSURLSessionTask*) productsGetWithFilter: (NSString*) filter
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGProductPage*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGProductPage*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) productsGetDetailWithId: (NSString*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGProductDetails*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGProductDetails*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) productsGetImageWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/Products/{id}/image"];
