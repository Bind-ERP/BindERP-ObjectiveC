...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"_iD", @"rFC", @"legalName", @"commercialName", @"creditDays", @"creditAmount", @"paymentMethod", @"creationDate", @"status", @"salesContact", @"creditContact", @"loctaion", @"comments", @"priceList", @"paymentTermType", @"email", @"telephones", @"number", @"accountNumber", @"defaultDiscount", @"clientSource", @"account"];
