...
+ (JSONKeyMapper *)keyMapper {
  return [[JSONKeyMapper alloc] initWithModelToJSONDictionary:@{ @"_iD": @"ID", @"addressID": @"AddressID", @"clientID": @"ClientID", @"comments": @"Comments", @"currencyID": @"CurrencyID", @"discountAmount": @"DiscountAmount", @"discountType": @"DiscountType", @"docNumberID": @"DocNumberID", @"exchangeRate": @"ExchangeRate", @"iSRRate": @"ISRRate", @"locationID": @"LocationID", @"orderDate": @"OrderDate", @"priceListID": @"PriceListID", @"purchaseOrder": @"PurchaseOrder", @"vATRate": @"VATRate", @"vATRetRate": @"VATRetRate", @"warehouseID": @"WarehouseID", @"emails": @"Emails", @"products": @"Products", @"services": @"Services" }];
}
